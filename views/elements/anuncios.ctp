<div style="margin-left: 10%; position: relative; top:13px; width:728px; height:90px;">
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="<?php echo $html->url('../img/imagens/full-banner_intitu.swf')?>" width="728" height="90">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="6.0.65.0" />
