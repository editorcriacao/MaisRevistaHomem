 ...
 */
	Router::connect('/', array('controller' => 'pages', 'action' => 'display', 'home'));
        Router::connect('/revista', array('controller' => 'pages', 'action' => 'display', 'revista'));
        Router::connect('/colunistas', array('controller' => 'pages', 'action' => 'display', 'colunistas'));
        Router::connect('/leitor', array('controller' => 'pages', 'action' => 'display', 'leitor'));
